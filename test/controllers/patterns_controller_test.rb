...
class PatternsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post patterns_url, params: { pattern: { description: @pattern.description, images: @pattern.images, name: @pattern.name, price: @pattern.price } }
    end
  ...
  test "should update pattern" do
    patch pattern_url(@pattern), params: { pattern: { description: @pattern.description, images: @pattern.images, name: @pattern.name, price: @pattern.price } }
